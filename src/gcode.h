...
#ifndef gcode_h
#define gcode_h
#include "main.h" // !! Ikke orginalt en del av koden, men virker nødvendig for å få uint8_t til å fungere. evt bruke #include <stdint.h>, men da får vi feil ved N_AXIS referanse
/* 
    ...
    ? Dokumentasjon: https://tsapps.nist.gov/publication/get_pdf.cfm?pub_id=823374
*/ 
...
#define MODAL_GROUP_M7 12 // [M3,M4,M5] Spindle turning //!! Unødvendig
#define MODAL_GROUP_M8 13 // [M7,M8,M9] Coolant control //!! Unødvendig
...
typedef struct {
  ...
  float r;         // Arc radius
  float s;         // Spindle speed // !! ikke nødvendig for oss
...
typedef struct {
  ...
  float spindle_speed;          // RPM // !! Unødvendig mtp vi ikke har noe RPM å kontrollere
