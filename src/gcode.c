/*
    G-Kode tolker
    Alt dette er tolking av G-Kode og sending av kommandoer i forhold til G-Koden lest fra linjen.
    Det meste vi kan fjerne og endre på er status, spindel kontroll og kjøling.
    TODO: Lese igjennom og fjerne unødvendig kode, evt ta inspirasjon og skrive egen forenklet kode.
...
uint8_t gc_execute_line(char *line) 
{
  ...
  float value;
  uint8_t int_value = 0;
  uint16_t mantissa = 0; // Verdien etter '.' i et desimal tall. feks: 2.71828, mantissa blir da 0.71828
